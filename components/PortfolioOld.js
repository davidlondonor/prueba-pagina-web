						...
						<div className="portfolio__wrapper">
							<div className="portfolio__content">
								...
								<div className="portfolio__menu">
									...
									<button
										onClick={() =>
											filterItem("Transformacion Digital")
										}
									>
									...
									<button
										onClick={() =>
											filterItem("Inteligencia emocional")
										}
									>
										Inteligencia emocional
									</button>
									<button
										onClick={() => filterItem("Certificaciones B")}
									>
										Certificaciones B para empresas
									</button>
									<button onClick={() => filterItem("PNL")}>
										PNL para empresas
									</button>
								</div>
							</div>
